...
The source CSV ``mdr/iso20022/MDR-ISO20022-MSG-FULL.csv`` ships in the
repo with 810 real ISO 20022 message definitions; this script packs
those into a dpack that an MCP server tool can resolve against.
