...
file. The dpack is packed with real ICD-10-CM code numbers as keys, so the
MCP `osmp_resolve` tool returns clinically usable results for those codes.
