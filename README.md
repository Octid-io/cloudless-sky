...
| **Rust** | `cargo add osmp` | [sdk/rust/](sdk/rust/) — pre-1.0 (0.3.0); full wire-format parity (FNP packet codec, SAIL binary, SEC envelope) + ASD core + v16 + EML + 89-macro registry |
